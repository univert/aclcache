...
if defined ACLCACHE_BASE_HASH_FILE (
   @echo Use ACLCACHE_BASE_HASH_FILE "%ACLCACHE_BASE_HASH_FILE%"
   "%ACLCACHE_PYTHON%\python.exe" "%ACLCACHE_LOCATION%\aclcache.py" --basehash "%ACLCACHE_BASE_HASH_FILE%"
)
...
@echo ACLCACHE_BASE_HASH_FILE=%ACLCACHE_BASE_HASH_FILE%
